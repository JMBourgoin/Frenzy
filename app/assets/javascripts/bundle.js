...
function () {
  ...
  _createClass(SoundCollection, [{
    ...
    key: "playClear",
    value: function playClear() {
      this.clear.play();
    }
  }, {
    key: "playCenter",
    value: function playCenter() {
      this.center.play();
    }
  }, {
    key: "playGameOver",
...
/* harmony default export */ __webpack_exports__["default"] = (SoundCollection);
